...
class Searx {
  ...
  Future<List<SearchResult>> getSearchResults(String query, {int page = 1}) async {
    ...
    try {
      for (var jsonResults in jsonResults) {
        ...
        int leech =
            jsonResults["leech"] != null ? int.parse(jsonResults["leech"].toString()) : null;
        int seed =
            jsonResults["seed"] != null ? int.parse(jsonResults["seed"].toString()) : null;
